...
- results/: evaluation results/plots from experiment runs
- HEFT-DLS_simulation_run.mp4: video of a full HEFT-DLS run
...
To run the simulation, navigate to the simulation/simu/ directory and execute main.py
