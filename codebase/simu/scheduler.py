...
class Scheduler:
    ...
    def handle_critical_faults(self, robot_obj):
        """
        Removes robot from any schedules and marks its task as unassigned 
        so it can be rescheduled to a different robot.
        """
    ...
    def are_all_orders_complete(self):
        return not (self._orders_backlog or self._orders_active)
