...
if __name__ == "__main__":
    ...
    orders = [[1,0],[5,0],[5,5], [10,0], [10, 5], [10,10], [20, 0]]
    fault_rates = [0.0, 0.0025]
    battery_options = [True, False]
    seeds = range(100, 200)

    warehouse_file = "whouses/whouse_2s_2o_6r.txt"
    output_dir = "6_robot_layout_results/"
    ...
    for order in orders:
        for fault_rate in fault_rates:
            for use_battery in battery_options:
                ...
                output_path = f"{output_dir}{unique_id}_{fault_rate}_{use_battery}_{order[0]}_{order[1]}.csv"
                # Save to CSV
